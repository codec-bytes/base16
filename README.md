...
[![Tests](https://img.shields.io/github/workflow/status/codec-bytes/base16/ci:test?event=push&label=tests)](https://github.com/codec-bytes/base16/actions/workflows/ci:test.yml?query=branch:main)
